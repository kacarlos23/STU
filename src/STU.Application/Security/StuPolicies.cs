...
public static class StuPolicies
{
    public const string PasswordChanged = "PasswordChanged";
    public const string GlobalAdministration = "GlobalAdministration";
    ...
    public const string HealthUnitUsersManage = "HealthUnitUsersManage";
    public const string OperationalWorkflows = "OperationalWorkflows";
}
